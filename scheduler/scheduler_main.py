...
from api.event.models import Event, Attendance
...
def mark_absent_for_past_events():
    ...
    for event in events:
        ...
        gen_members = GenMember.objects.filter(generation=event.generation, is_current=True)
    ...
    logger.info("Completed mark_absent_for_past_events job")
