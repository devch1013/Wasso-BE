...
class GenerationViewTest(TestCase):
    ...
    def setUp(self, mock_storage):
        ...
        self.user1 = User.objects.create_user(username="testuser1", identifier="testuser1")
        self.user2 = User.objects.create_user(username="testuser2", identifier="testuser2")
        self.user3 = User.objects.create_user(username="testuser3", identifier="testuser3")
